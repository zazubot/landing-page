    ...
    <>
      ...
      <main className="relative flex grow">
        <div
          ...
          aria-hidden="true"
        >
          <div className="h-80 w-80 rounded-full bg-linear-to-tr from-orange-500 opacity-70 blur-[160px]"></div>
        </div>
        ...
        <>
          ...
          <div className="relative my-6 mr-6 hidden w-[572px] shrink-0 overflow-hidden rounded-2xl lg:block">
            ...
            <div className="absolute left-32 top-1/2 w-[500px] -translate-y-1/2">
              <div className="aspect-video w-full rounded-2xl bg-neutral-900 px-5 py-3 shadow-xl transition duration-300">
                ...
                <div className="font-mono text-sm text-neutral-500 transition duration-300 [&_span]:opacity-0">
