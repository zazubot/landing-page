  ...
  return (
    <div className="relative rounded-lg bg-white/70 shadow-sm shadow-black/[0.03] before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:border before:border-transparent before:[background:linear-gradient(var(--color-neutral-100),var(--color-neutral-200))_border-box] before:[mask-composite:exclude_!important] before:[mask:linear-gradient(white_0_0)_padding-box,_linear-gradient(white_0_0)]">
      <h2>
        ...
        >
          ...
          <span className="ml-8 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-white shadow-xs">
            <svg
              className={`origin-center transform fill-neutral-400 transition duration-200 ease-out ${
      ...
      <div
        ...
        className={`grid overflow-hidden text-sm text-neutral-600 transition-all duration-300 ease-in-out ${
          accordionOpen
