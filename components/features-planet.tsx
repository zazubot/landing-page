        ...
        <div>
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 *:relative *:p-6 *:before:absolute *:before:bg-neutral-800 *:before:[block-size:100vh] *:before:[inline-size:1px] *:before:[inset-block-start:0] *:before:[inset-inline-start:-1px] *:after:absolute *:after:bg-neutral-800 *:after:[block-size:1px] *:after:[inline-size:100vw] *:after:[inset-block-start:-1px] *:after:[inset-inline-start:0] md:*:p-10">
            ...
            <article>
              ...
              <p className="text-[15px] text-neutral-400">
                Offer personalized recommendations and tailored customer
                support.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-neutral-200">
                ...
                <span>Help your customers 24/7</span>
              </h3>
              <p className="text-[15px] text-neutral-400">
                Offer consistent support across channels and let customers
                resolve issues whenever they want.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-neutral-200">
                ...
                <span>Resolve problems faster</span>
              </h3>
              <p className="text-[15px] text-neutral-400">
                Explain technical problems using visuals and interactive forms
                to shorten the resolution time.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-neutral-200">
              ...
              <p className="text-[15px] text-neutral-400">
                Automate answering repetitive questions to let your team focus
            ...
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-neutral-200">
                ...
                <span>Get more leads on your site</span>
              </h3>
              <p className="text-[15px] text-neutral-400">
                Add Chat Widget to your website with a few simple clicks to make
                it easier for customers to contact you.
              </p>
            </article>
          </div>
        </div>
