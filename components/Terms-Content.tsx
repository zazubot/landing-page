        ...
        <div className="py-8 md:py-20">
          <div className="py-5">
            <h3 className="text-2xl  font-bold text-neutral-900">
              Typebot Terms of Service
            </h3>
            <hr />
            <p className="py-8">
              When we say ”company”, “we”, “our”, “us”, ”service” or ”services”
              in this document, we are referring to Typebot. We may update these
          ...
          <div className="py-5">
            ...
            <p className="py-8">
              ...
              and password. Typebot cannot and will not be liable for any loss
          ...
          <div className="py-5">
            ...
            <p>Typebot prohibits content and activities that:</p>
          ...
          <div className="py-5">
            ...
            <p className="py-8">
              ...
              privacy. When using Typebot, you 100% own and control all of your
